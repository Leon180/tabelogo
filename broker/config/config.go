...
type Config struct {
	...
	WebPort                 string `mapstructure:"WEBPORT"`
	TabelogSpiderServiceURL string `mapstructure:"TABELOG_SPIDER_SERVICE_URL"`
	AuthenticateServiceURL  string `mapstructure:"AUTHENTICATE_SERVICE_URL"`
	GoogleMapServiceURL     string `mapstructure:"GOOGLE_MAP_SERVICE_URL"`
